...
namespace ElibraryManagement
{
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        {
            string sessionrole = Session["username"] as string;
            try
            {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@account_status", "pending");//here accpount status would be pending until admin aproves it
